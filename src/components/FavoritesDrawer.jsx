...
export default function FavoritesDrawer({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-gray-900/50 backdrop-blur-xs animate-fade-in">
      ...
      <div className="relative w-full max-w-sm bg-white h-full shadow-2xl z-10 flex flex-col justify-between border-l border-gray-100">
        {/* Header */}
        <div className="p-4 border-b border-gray-100 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-xl">⭐️</span>
            <div>
              <h2 className="font-extrabold text-gray-900 text-sm">Clinical Favorites</h2>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-5">
          {starredDrugs.length === 0 && starredProtocols.length === 0 && (
            <div className="py-16 text-center">
              ...
              <h3 className="font-bold text-gray-800 text-sm mb-1">No Saved Favorites</h3>
              ...
              <div className="space-y-2">
                {starredDrugs.map(drug => (
                  <div
                    ...
                    className="p-3 bg-gray-50/80 hover:bg-indigo-50/60 rounded-2xl border border-gray-100 transition-colors cursor-pointer flex items-center justify-between group"
                  >
                    <div>
                      <h4 className="font-extrabold text-xs text-gray-900 group-hover:text-indigo-600">
                        {drug.name}
                      </h4>
                    ...
                    <button
                      ...
                      className="text-amber-500 hover:text-gray-300 text-sm p-1"
          ...
          {starredProtocols.length > 0 && (
            <div>
              <p className="text-[10px] font-black uppercase tracking-wider text-purple-700 mb-2 flex items-center gap-1">
                <span>🔄</span>
              ...
              <div className="space-y-2">
                {starredProtocols.map(proto => (
                  <div
                    ...
                    className="p-3 bg-purple-50/40 hover:bg-purple-50 rounded-2xl border border-purple-100 transition-colors cursor-pointer flex items-center justify-between group"
                  >
                    <div>
                      <h4 className="font-extrabold text-xs text-gray-900 group-hover:text-purple-700">
                        #{proto.number} {proto.title}
                      </h4>
                      <p className="text-[10px] text-purple-600 truncate max-w-[200px]">
